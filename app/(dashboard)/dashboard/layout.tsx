...
export default function DashboardWebflowLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <Script id="dashboard-webflow-fonts" strategy="beforeInteractive">
        {`WebFont.load({ google: { families: ["Figtree:300,400,500,600,700"] } });`}
      </Script>
      <Script id="dashboard-webflow-flags" strategy="beforeInteractive">
